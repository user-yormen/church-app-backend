    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(PUT, "/api/v1/users/**").hasAnyAuthority("ADMIN", BACKOFFICE_SCOPE, "BACKOFFICE_USER_MANAGE", CHURCH_SCOPE, "ROLE_ASSIGN")
                        .requestMatchers(DELETE, "/api/v1/users/**").hasAnyAuthority("ADMIN", BACKOFFICE_SCOPE, "BACKOFFICE_USER_MANAGE", CHURCH_SCOPE, "ROLE_ASSIGN")
                        ...
                        .requestMatchers(POST, "/api/v1/roles/**").hasAnyAuthority("ADMIN", BACKOFFICE_SCOPE, "BACKOFFICE_ROLE_MANAGE", CHURCH_SCOPE, "ROLE_ASSIGN")
                        .requestMatchers(PUT, "/api/v1/roles/**").hasAnyAuthority("ADMIN", BACKOFFICE_SCOPE, "BACKOFFICE_ROLE_MANAGE", CHURCH_SCOPE, "ROLE_ASSIGN")
                        .requestMatchers(DELETE, "/api/v1/roles/**").hasAnyAuthority("ADMIN", BACKOFFICE_SCOPE, "BACKOFFICE_ROLE_MANAGE", CHURCH_SCOPE, "ROLE_ASSIGN")
                        .requestMatchers(GET, "/api/v1/roles/**").hasAnyAuthority("ADMIN", BACKOFFICE_SCOPE, "BACKOFFICE_ROLE_MANAGE", CHURCH_SCOPE, "ROLE_ASSIGN")
